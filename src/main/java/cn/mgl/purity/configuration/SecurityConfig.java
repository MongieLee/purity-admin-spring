...
import cn.mgl.purity.security.JWTAuthenticationFilter;
import cn.mgl.purity.security.LoginFailureHandler;
import cn.mgl.purity.security.LoginSuccessHandler;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/test/**", "/uploadFiles/**", "/api/v1/auth/**", "/swagger-ui.html", "/webjars/**", "/error/**"
